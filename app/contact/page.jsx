          ...
          <div className="grid lg:grid-cols-[0.9fr_1.1fr] gap-10">
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              ...
              >
                ...
                <h3 className="mt-8 text-2xl text-[#111111]">Address</h3>
              ...
              >
                ...
                <h3 className="mt-8 text-2xl text-[#111111]">Email</h3>
              ...
              >
                ...
                <h3 className="mt-8 text-2xl text-[#111111]">Phone</h3>

                <a
                  href="tel:+917567756758"
                  className="mt-5 block text-black/60 hover:text-[#B68D40] transition"
                >
                  +91 7567 7567 58/59
                </a>
              </motion.div>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-[#111111] text-white rounded-[2.5rem] p-8"
              >
                <div className="w-14 h-14 rounded-2xl bg-white/10 flex items-center justify-center">
                  <Clock3 size={24} className="text-[#D4A514]" />
                </div>

                <h3 className="mt-8 text-2xl">Office Hours</h3>
      ...
      <section className="pb-24">
        <Container>
          <motion.div
            ...
            viewport={{ once: true }}
            className="rounded-[3rem] overflow-hidden border border-black/5 bg-white"
          >
            {/* MAP */}
            ...
            {/* BOTTOM */}
            <div className="px-8 py-7 border-t border-black/5 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              <div>
                <p className="uppercase tracking-[0.2em] text-xs text-black/40">
                  Campus Navigation
                </p>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="h-14 px-7 rounded-full bg-[#111111] text-white flex items-center justify-center gap-3 hover:bg-[#B68D40] transition-all duration-500 shrink-0"
              >
                Open in Google Maps
